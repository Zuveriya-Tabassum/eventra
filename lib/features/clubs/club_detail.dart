...
import '../../data/models/club_model.dart'; // Your Club model
import '../events/fests_list.dart'; // contains FestsListPage(isAdmin,currentUserId)
              ...
              TextButton(
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => const FestsListPage(),
                    ),
                  );
                },
